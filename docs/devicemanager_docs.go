...
const docTemplatedevicemanager = `{
...
// SwaggerInfodevicemanager holds exported Swagger Info so clients can modify it
var SwaggerInfodevicemanager = &swag.Spec{
	Version:          "0.1",
	Host:             "",
	BasePath:         "/",
	Schemes:          []string{},
	...
	Description:      "",
	InfoInstanceName: "devicemanager",
	SwaggerTemplate:  docTemplatedevicemanager,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfodevicemanager.InstanceName(), SwaggerInfodevicemanager)
}
